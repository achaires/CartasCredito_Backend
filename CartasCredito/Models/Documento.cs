...
namespace CartasCredito.Models
{
	public class Documento
	{
		...
		public static List<Documento> Get(int activo = 1)
		{
			...
			try
			{
				...
				var errores = "";
				if (da.Cons_Documentos(out dt, out errores, activo))
				{
					if (dt.Rows.Count > 0)
					{
		...
		public static RespuestaFormato Insert(Documento modelo)
		{
			...
			try
			{
				...
				if (da.Ins_Documento(modelo, out dt, out errores))
				{
					if (dt.Rows.Count > 0)
					{
						var row = dt.Rows[0];
